# UJIAN Angular (Dea Aldy Alfian | 2014157035 | Informatika (B))
...
```
- Download Laravel-api here : [Download Here](https://github.com/fastikom/uas-b-Dealdy), which we used as a RESTful api.
